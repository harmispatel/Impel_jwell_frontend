...
const Shop = ({ product }) => {
  ...
  const handleTag = (e) => {
    ...
    if (e.target.checked) {
      ...
      setTag(tag.filter((item) => item !== parseFloat(e.target.value)));
      AllData();
    }
  };
...
//       fetchProductsByTag(selectedTag);
//     } else {
//       if (e.target.checked) {
//         setTag([...tag, selectedTag]);
//       } else {
//         setTag(tag.filter((item) => item !== selectedTag));
//         AllData();
//       }
//     }
//   };
//   const fetchProductsByTag = (selectedTag) => {
//     const userData = {
//       categoryIds: category,
//       GenderIds: gender,
//       TagIds: [selectedTag],
